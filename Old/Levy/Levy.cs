...
namespace BrandonBox.NPCs.Levy
{
	// [AutoloadHead] and NPC.townNPC are extremely important and absolutely both necessary for any Town NPC to work at all.
	[AutoloadHead]
	public class Levy : ModNPC
	{
		...
		public override string GetChat() {
			...
			chat.Add("This place isn't safe, I fell them coming.");
			chat.Add("I'm not a hero, I'm a survivor.");
			chat.Add("You can't kill me, I'm already dead.");
			chat.Add("I'm not here to make friends, I'm here to kill.");
